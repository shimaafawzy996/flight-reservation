                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
                                ...
                                <form id="form-submit" action="{{route('customers.store')}}" method="POST">
                                {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <input name="deparure" type="text" class="form-control date" id="deparure" placeholder="Select date..." required=""  data-date-format="dd-mm-yyyy">
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6">
                                            <fieldset>
                                                <label for="return">Return date:</label>
                                                <input name="return1" type="text" class="form-control date" id="return" placeholder="Select date..." required=""  data-date-format="dd-mm-yyyy">
                                            </fieldset>
                                        </div>
                                            ...
                                            <div class="radio-select">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        ...
                                                        <input type="radio" name="trip" <?php if (isset($trip) && $trip=="round") echo "checked"; ?> id="round" value="round" required="required" >
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                                        <label for="oneway">Oneway</label>
                                                        <input type="radio" name="trip" <?php if (isset($trip) && $trip=="oneway") echo "checked"; ?> id="oneway" value="one-way" required="required" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <div class="weather-icon">
                                                            <img src="{{asset('img/weather-icon-03.png')}}" alt="">
                                                        </div>
                                                        <span>32&deg;C</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>Thailand</h6>
                                                        <div class="weather-icon">
                                                            <img src="{{asset('img/weather-icon-02.png')}}" alt="">
                                                        </div>
                                                        <span>28&deg;C</span>
                                                        <ul class="time-weather">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>India</h6>
                                                        <div class="weather-icon">
                                                            <img src="{{asset('img/weather-icon-01.png')}}" alt="">
                                                        </div>
                                                        <span>33&deg;C</span>
                                                        <ul class="time-weather">
                                                            <li>6AM <span>26&deg;</span></li>
                ...
                <div class="wrapper">
                    ...
                    <div class="col-md-8">
                        <section id="third-tab-group" class="recommendedgroup">
                            ...
                            <div id="fitness">
                                <img src="{{asset('img/fitness-service.jpg')}}" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="event">
                                <img src="{{asset('img/evening-event.jpg')}}" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                    ...
                    <div id="owl-mostvisited" class="owl-carousel owl-theme">
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="{{asset('img/place-01.jpg')}}" alt="">
                                <div class="text-content">
                                    <h4>River Views</h4>
                                    <span>New York</span>
                                </div>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="{{asset('img/place-02.jpg')}}" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="{{asset('img/place-03.jpg')}}" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="{{asset('img/place-04.jpg')}}" alt="">
                                <div class="text-content">
